...
const LandingPriceContent = () => {
  return (
    <Box marginTop="16px">
      {/* Top Info */}
      <Typography id="price" variant="feature_heading">
        Our Prices
      </Typography>
        ...
        <Grid item sx={4}>
          <Box>
            <LandingPriceCard
              ...
              featureDescriptions={[
                "Access to one of our premade budget templates to set you off on the right foot.",
        ...
        <Grid item sx={4}>
          <Box>
            <LandingPriceCard
              ...
              priceAmount={"$9"}
              priceText={
                "One lifetime license for the financially-savvy who value long term planning."
              }
              features={[
              ...
              featureDescriptions={[
                "Gain access to everything in our previous tiers.",
        ...
        <Grid item sx={4}>
          <Box>
            <LandingPriceCard
              ...
              priceAmount={"$29"}
              priceText={
                "Power features for data-driven users who wants their data, their own way."
              }
              features={[
