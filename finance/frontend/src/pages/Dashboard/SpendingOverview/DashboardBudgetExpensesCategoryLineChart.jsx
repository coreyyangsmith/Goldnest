//-------------------------------------------------------//
//  File Name: DashboardBudgetExpensesCategoryLineChart.jsx
...
//
//  Returns:
//      -  ECharts Line Chart (for Selected Main)
//
...
const DashboardBudgetExpensesCategoryLineChart = (props) => {
    // Custom Hooks
    ...
    useEffect(() => {
        ...
        function getCumulativeBudgetByDay() {
            ...
            const mySummedBudget = budgetByMainCategory.reduce((total, budget) => total + budget.amount, 0);
    ...
    const option = {
        title: {
          text: 'Budget vs Expenses - ' + (props.selectedMain.name != undefined ? props.selectedMain.name : "No Category Selected"),
          top: '1%',
        },
        tooltip: {
          trigger: 'axis'
...
export default DashboardBudgetExpensesCategoryLineChart;