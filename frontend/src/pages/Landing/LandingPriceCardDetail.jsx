...
const LandingPriceCardDetail = (props) => {
    ...
    return (
      <React.Fragment>
        <Stack direction="row">
          ...
          <Typography paddingLeft={2} variant="prices_card_heading">
            {value}
          </Typography>
          <Typography paddingLeft={1} variant="prices_card_body">
            {myFeaureDescription}
          </Typography>
        </Stack>
      </React.Fragment>
  ...
  return (
    <Paper
      elevation={2}
      sx={{ background: "#f3f3f3", minHeight: "150px", padding: "32px" }}
    >
      <Chip
