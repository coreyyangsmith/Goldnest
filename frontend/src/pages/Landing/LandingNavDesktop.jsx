      ...
      <Toolbar variant="regular" sx={toolbarSX}>
        <Grid container justifyContent="space-evenly" alignItems="stretch">
          ...
          <Grid
            ...
            alignItems="center"
          >
            <StyledHashLink smooth to="/#features">
              <Typography variant="landing_menu">Features</Typography>
            </StyledHashLink>
            <StyledHashLink smooth to="/#price">
              <Typography variant="landing_menu">Pricing</Typography>
            </StyledHashLink>
            <StyledHashLink smooth to="/#contact">
              <Typography variant="landing_menu">About Us</Typography>
            </StyledHashLink>
          </Grid>
